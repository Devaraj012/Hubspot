...
if response.status_code == 200:
    ...
    for company in companies_data.get('results', []):
        ...
        companies_list.append([company_id, name, domain, industry, phone, annual_revenue])

    df_companies = pd.DataFrame(companies_list, columns=['Company ID', 'Name', 'Domain', 'Industry', 'Phone', 'Annual Revenue'])

    excel_companies_filename = 'hubspot_companies.csv'
